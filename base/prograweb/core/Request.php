...
class Request
{
    ...
    private array $headers; //  Encabezados HTTP, como Authorization o Content-Type
    private array $queryParams; // Datos de la URL, como ?page=2
    private array $body; // Datos JSON decodificados del cuerpo de la peticion
    private array $routeParams = []; // Parametros extraidos de la ruta, como {id} en /empleados/{id}
